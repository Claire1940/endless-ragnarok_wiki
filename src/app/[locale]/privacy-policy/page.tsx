...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Endless Ragnarok Wiki',
    description: 'Endless Ragnarok Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Granblue Fantasy: Relink resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Endless Ragnarok Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <p>
              Our website may contain links to external websites, including Steam, PlayStation Network, Nintendo, Discord, and social media platforms.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Endless Ragnarok Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Cygames, Inc. or the official Granblue Fantasy: Relink developers. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@endless-ragnarok.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@endless-ragnarok.wiki</a>
            </p>
            <p>
