...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Endless Ragnarok Wiki',
    description: 'Copyright and intellectual property information for Endless Ragnarok Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Endless Ragnarok Wiki',
      description: 'Copyright and intellectual property information for Endless Ragnarok Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Endless Ragnarok Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Endless Ragnarok Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Endless Ragnarok Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Cygames, Inc.</strong> - Developer and publisher of Granblue Fantasy: Relink</li>
              <li><strong>Platform Owners</strong> - Valve (Steam), Sony (PlayStation), and Nintendo</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>Granblue Fantasy: Relink / Endless Ragnarok</strong> - Trademark of Cygames, Inc.</li>
              ...
              <li><strong>Nintendo Switch</strong> - Trademark of Nintendo</li>
              <li><strong>Endless Ragnarok Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Endless Ragnarok Wiki.
            </p>
            ...
            <p>
              ...
              Endless Ragnarok Wiki<br />
              Email: <a href="mailto:dmca@endless-ragnarok.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@endless-ragnarok.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Endless Ragnarok Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Endless Ragnarok Wiki (endless-ragnarok.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@endless-ragnarok.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@endless-ragnarok.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@endless-ragnarok.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@endless-ragnarok.wiki</a>
            </p>
            <p>
