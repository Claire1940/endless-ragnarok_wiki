...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Endless Ragnarok Wiki",
    description: "Read the Terms of Service for Endless Ragnarok Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Granblue Fantasy: Relink resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Endless Ragnarok Wiki",
      description: "Terms and conditions for using Endless Ragnarok Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Endless Ragnarok Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Endless Ragnarok Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Endless Ragnarok Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Endless Ragnarok Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to Granblue Fantasy: Relink and its Endless Ragnarok expansion. Our services include, but are not limited to:
            </p>
            <ul>
              <li>Boss guides and battle strategies</li>
              <li>Weapon and sigil build guides</li>
              <li>Character and party composition info</li>
              <li>Quest and mission walkthroughs</li>
              <li>Achievement and trophy guides</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Endless Ragnarok Wiki is NOT affiliated with, endorsed by, or associated with
              Cygames, Inc. or the official Granblue Fantasy: Relink developers. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Endless Ragnarok Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Cygames, Inc. and/or the Granblue Fantasy: Relink developers. We use such
            ...
            <ul>
              ...
              <li><strong>Game Updates:</strong> Game content, patch notes, and platform availability may change without notice. We are not responsible for in-game changes or platform-specific features.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, ENDLESS RAGNAROK WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including Steam, PlayStation Network, Nintendo, Discord, social media platforms,
            ...
            <p>
              ...
              you and Endless Ragnarok Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@endless-ragnarok.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@endless-ragnarok.wiki</a>
            </p>
            <p>
