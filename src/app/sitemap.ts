...
const BASE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.endless-ragnarok.wiki'

// 内容类型优先级配置（与 navigation.ts CONTENT_TYPES 对齐）
...
// 内容更新频率配置（与 navigation.ts CONTENT_TYPES 对齐）
